## Code for print_stan_code
## Originial library for this code is biostan https://github.com/jburos/biostan
## author @jburos https://github.com/jburos
## included here for convinience as installation of biostan requires rstan > 2.19 which is not installable in local branch.
